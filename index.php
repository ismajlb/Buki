				...
				<ul class="slider-items">
					<li>
						...
						<div class="slide-entry">
							<h2><span> Beautiful</span> Jewelry</h2>
					...
					<li>
						...
						<div class="slide-entry">
							<h4><span>Perfect </span><span class="small"></span><span>Ring</h4>
							<a href="products.php" class="button" title="Buy now"><span>Buy now</span></a>
						</div>
					</li>
					<li>
					...
					<li>
						...
						<div class="slide-entry">
							<h2><span>Womans </span>Jewelry</h2>
					...
					<li>
						...
						<div class="slide-entry">
							<h4><span>New</span><span class="small"></span><span> Style</span> Jewelry</h4>
					...
					<li>
						...
						<div class="slide-entry">
							...
							<h4 class="short"><span>Classic</span> Jewelry</h4>
